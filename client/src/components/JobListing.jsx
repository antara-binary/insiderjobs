...
const [selectedLocations, setSelectedLocatios]= useState([])

const [filteredJobs,setFilteredJobs]=useState(jobs)


/*jkn category te search option e kichu click krbo tkn tkn ei function ta kaj krbe karon 
 joblisting te ei function ta attach kora ache */
...
// ei useeffect ta category r location ja choose krbo sei onujayi filter hbe job options
...
<section className='w-full lg:w-3/4 text-gray-800 maxlg:px-4'>
    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4'>
        ...
        {/**pagination */}
         {/**prothom page e 2 to job grid show hbe porere page e baki gulo page nation er sahajje niye jabo */}
